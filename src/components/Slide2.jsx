    ...
    <div className="slider-container sl">
      <Slider {...sliderSettings}>
        <div className="slide-item">
          <img 
            src="https://myrausa.com/cdn/shop/files/S-9672-_5_-copy_400x.jpg?v=1704967452" 
            alt="Product 1" 
        ...
        <div className="slide-item">
          <img 
            src="https://myrausa.com/cdn/shop/files/B24W-10292-T-_1_400x.jpg?v=1719734740" 
            alt="Product 2" 
            className="slide-image"
          />
          <p>chimayu</p>
        ...
        <div className="slide-item">
          <img 
            src="https://myrausa.com/cdn/shop/files/B24W-10291-T-_1_1_400x.jpg?v=1719830063" 
            alt="Product 3" 
            className="slide-image"
          />
          <p>chimayu</p>
